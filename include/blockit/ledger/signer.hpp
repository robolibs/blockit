...
namespace blockit {
    namespace ledger {
        ...
        inline dp::Result<EVP_PKEY *, dp::Error> loadPublicKeyFromPEM(const std::string &pemPublic) {
            ...
            if (key->public_key.empty()) {
                delete key;
                return dp::Result<EVP_PKEY *, dp::Error>::err(
                    dp::Error::invalid_argument("Empty or invalid public key"));
            }
        ...
        class Crypto {
          public:
            ...
            inline dp::Result<std::vector<unsigned char>, dp::Error>
    ...
    // Backward compatibility: expose commonly used types in blockit namespace
    using ledger::base64Decode;
    using ledger::base64Encode;
    using ledger::Crypto;
    using ledger::EVP_PKEY;
    using ledger::loadPublicKeyFromPEM;
    using ledger::stringToVector;
    using ledger::vectorToString;
    using ledger::verify;
